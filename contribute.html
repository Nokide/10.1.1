...
<html>
  <head>
    ...
    <link rel="stylesheet" href="myform/form.css" >
    <link rel="handler" href="/myform/handler.php"
    <script src="/form.js"></script>
  </head>
<body>
<!--Page Title-->
  <div class="secondtitle">
      <div><a class="secondtitle" href="index.html">Hellō</a></h2>
        <!--Spacer-->
      <div class="space">
        <hr/>
      </div>
<!-- Index -->
  <div class="wrap">
    ...
    <a href="gallery.html">Gallery</a>
      ...
      <!--Contribute-->
      <h2><a id="current" href="Contribute.html">Contribute</a></h2>
  </div>
  <!-- Load Icon Bar  -->
  ...
  <!-- Icon Bar -->
    ...
    <!-- Form Started -->
      ...
      <form class="contact-form" action="contributeform.php" method="post">
